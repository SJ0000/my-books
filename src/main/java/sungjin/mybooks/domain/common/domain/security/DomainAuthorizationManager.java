...
import sungjin.mybooks.domain.common.domain.security.handler.DomainAuthorizationHandler;
...
public class DomainAuthorizationManager {

    private final Map<Class<?>, DomainAuthorizationHandler> handlers = new HashMap<>();
    private final UserRepository userRepository;

    public void addHandler(Class<?> type, DomainAuthorizationHandler handler) {
    ...
    public void authorize(Long userId, Class<?> type, Long entityId) {
        ...
        DomainAuthorizationHandler handler = handlers.get(type);
